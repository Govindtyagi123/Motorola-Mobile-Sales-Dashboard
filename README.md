...
* Identify monthly quantity trends.
...
The monthly trend displays the **total quantity sold from January to December**, making it easier to identify changes in sales volume throughout the year.

### 3. Customer Ratings

The dashboard displays the distribution of customer ratings from **1 to 5**, providing insights into customer satisfaction.
...
The dashboard compares **total sales by mobile model**, helping identify the best-performing mobile models.
...
The dashboard includes a brand-level analysis showing:
...
Brands visible in the dashboard include:
...
* Customer preferences across different payment methods.
...
2. Open `Motorola_Mobile_Sales.pbit` using **Microsoft Power BI Desktop**.
3. Refresh or configure the data source if prompted.
4. Explore the dashboard using the available slicers and visualizations.
5. Select different brands, mobile models, payment methods, months, and days to perform interactive analysis.
